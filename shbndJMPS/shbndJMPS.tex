...
\begin{proposition} \label{prop:factor}$\exists \tau_0$ such that for $\tau\ge\tau_0$
 \begin{enumerate}
  ...
  \item $(\tau-\tau_0)^{\tfrac{3}{2}} \big|P(\tau)^{-1}P'(\tau)\big|.$ %$\displaystyle \int_{\tau_0}^\infty \big|P_{ij}'(s)\big|\; ds < \infty$ for all $i,j=1,2,3$.
 \end{enumerate}
\end{proposition}
\begin{proof}
...
where the exponent $\chi=\chi(k,\alpha,m)=2k\sqrt{\frac{\alpha-m}{(1+m)}}> 0$ that is linear in $k$. % and is unbounded as $k \rightarrow \infty$
%  \begin{enumerate}
...
%    \end{equation}
%    \item The exponent $\chi=\chi(k,\alpha,m)=2k\sqrt{\frac{\alpha-m}{(1+m)}}$ and is unbounded as $k \rightarrow \infty$.
%  \end{enumerate}
\end{theorem}
