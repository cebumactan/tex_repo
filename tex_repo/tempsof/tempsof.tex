...
\begin{enumerate}
 ...
 \end{align*}
 Observe that the variable that is responsible for the softening is now $\tph$, which used be the $\gamma$ in the strain-softening model. Notice also that the exponent $-\frac{\alpha}{1+\alpha} >-1$ always holds for any $\alpha > 0$, which came as the constraint in the strain-softening model. 
\end{enumerate}
...
\begin{align*}
 ...
 n\frac{\drr}{r}&=n\frac{\dtu}{\tu} -n\frac{1+\alpha}{1+n}\,\frac{\dtth}{\tth}= \frac{\dts}{\ts} + \Big(\alpha-n\frac{1+\alpha}{1+n}\Big)\,\frac{\dtth}{\tth} & &=\left[\frac{\alpha-n}{\lambda}\Big(\frac{\ts\tu}{\tth}-c_0\Big)\right]& &+\left[d_1 + b\frac{\tv}{\ts} + \lambda\frac{\tu}{\tv}\frac{\tv}{\ts}\right]
\end{align*}
Noticing that
\begin{align*}
...
\begin{align*}
 ...
 n\frac{\drr}{r}&=\Big[\frac{\alpha-n}{\lambda}\Big(r^{1+n}-c_0\Big)\Big]+\Big[d_1 + q + \lambda pr\Big]
\end{align*}
