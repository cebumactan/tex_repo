...
% \begin{align*}
%  \frac{\dot{s}}{s} = \frac{\dot{s^{f(n)}}}{s^{f(n)}} &= \frac{\dot{s^{f(n)}+1}}{s^{f(n)}} = \frac{\dot{s^{f(n)}+1}}{s^{f(n)}+1}\frac{s^{f(n)}+1}{s^{f(n)}} = \frac{s^{f(n)}+1}{s^{f(n)}} \left\{\Big[\frac{-1-m}{\lambda }\Big(r-a_0\Big)\Big] + \Big[\frac{1+\alpha}{\lambda }\Big(\frac{\ts\tu}{\tth}-c_0\Big)\Big]\right\}\\
%   &=\frac{s^{f(n)}+1}{s^{f(n)}} \bigg\{\Big[\frac{-1-m}{\lambda }r + \frac{a_0(1+m)-c_0(1+\alpha)}{\lambda}\Big] + \frac{1+\alpha}{\lambda}\frac{\ts\tu}{\tth}\bigg\}\\
%   \intertext{ using $\displaystyle z:= \frac{\ts\tu}{\tth} = \frac{1+m}{1+\alpha} \frac{u^n}{s^{f(n)}+1}\,r$ and $\displaystyle a_0(1+m)-c_0(1+\alpha)=\frac{-n(1+m)}{D}, $}
%   &=\frac{s^{f(n)}+1}{s^{f(n)}} \bigg\{\Big[-\frac{1+m}{\lambda }r - \frac{n(1+m)}{\lambda D}\Big] + \frac{1+m}{\lambda}\frac{u^n}{s^{f(n)}+1}\,r\bigg\}\\
%  {f(n)}\dot{s}&=(1+m)s^{1-{f(n)}} \left\{(s^{f(n)}+1) \Big[-\frac{1}{\lambda }r - \frac{n}{\lambda D}\Big] + \frac{1}{\lambda} {u^n}r\right\}.
% \end{align*}
$(p,q,r,s)$-system:
