...
to construct the perturbed heteroclinic orbit. We detail this in Section \ref{sec:proof}. More advanced results on Geometric singular perturbation theory can be found in \cite{fenichel_asymptotic_1974, fenichel_asymptotic_1977,fenichel_geometric_1979,HPS_1977,Sz1991,wiggins_normally_1994,KUEHN_2015}.
...
consists entirely of the equilibria of \eqref{eq:fast0}. We simply take one branch $\mathcal{S}_H$ and $K\subset\mathcal{S}_H$ compact, which will be called a {\it critical manifold}. We choose $K$ to be a graph $\big(D,\hat{r}(D)\big)$, where
\begin{equation*}
