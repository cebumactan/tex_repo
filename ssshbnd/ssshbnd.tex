...
$$ M_0, M_1 \quad \hookrightarrow \quad \text{$p\equiv0$, $s\equiv\tfrac{1+m}{1+\alpha}$ line} \quad \hookrightarrow \quad \text{$s\equiv\tfrac{1+m}{1+\alpha}$ plane} \quad \hookrightarrow \quad K$$
...
%  &(2) & & p=0, \ q=0, \ \underline{ r=0},\ s=s, \ \underline{ \lambda = -1 - \frac{n}{2(\alpha-m-n)}},\\
%  &(3) & & p=0, \ q=0, \ r = \frac{n\alpha - a(\alpha-m-n)}{(1+\alpha)(m+n)},\ \underline{ s=0},\\
%  &(4) & & p=0, \ q=1, \ \underline{ r=0, \ s=0}, \\
%  &(5) & & p=0, \ q=1, \ \underline{ r=0},\ s=s, \ \underline{ \lambda = \frac{2\alpha-2m-n}{1+m+n}},\\
%  &(6) & & p=0, \ q=1, \ r = \frac{n\alpha - a(\alpha-m-n)}{(1+\alpha)(m+n)}+\frac{\lambda}{m+n},\ \underline{ s=0},\\
