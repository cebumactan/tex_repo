...
Now, we verify $K_0\subset \mathcal{S}_H$. %the {\it Normally Hyperbolicity} of $K$. % upon the definition in \cite[p. 255]{Sz1991}.
...
% \end{definition}
\begin{proposition}
$K_0\subset \mathcal{S}_H$, i.e., the partial jacobian $\frac{\partial g}{\partial r}(p,q,r,s)|_{r=\hat{r}(p,q,s)} >0 $ for all $(p,q,r,s)\in K$. %$K$ is normally hyperbolic with respect to the Layer problem \eqref{eq:fast0}.
\end{proposition}
\begin{proof}
