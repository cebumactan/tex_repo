...
\begin{enumerate}
\item Min-Gi Lee, Athanasios Tzavaras, Existence of localizing solutions in plasticity via the geometric theory of singular perturbations, {\it preprint}.
\item Theodoros Katsaounis, Min-Gi Lee, Athanasios Tzavaras, Localization in inelastic rate dependent shearing deformations, {\it preprint}.
...
\section*{Visitings}
\begin{itemize}
  \item ECNU Center for PDE, Shanghai,  April 10-21, 2011.
\end{itemize}
