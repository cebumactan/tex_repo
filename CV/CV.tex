...
\begin{minipage}{0.7\linewidth}
    ...
    %Fax: &  (919) 962-5678 \\
    %Email: &
    \href{mailto:mingi.lee@kaust.edu.sa}{\tt mingi.lee@kaust.edu.sa} \\
    %Homepage: &
    \href{https://cebumactan.github.io/ming-lee}{\tt https://cebumactan.github.io/ming-lee} \\
    {}\\
...
\section*{Employment}
\begin{itemize}
  \item FEB 2018 moving to Gran Sasso Science Institute, L'aquila, Italy. Advisor: Pierangelo Marcati.
  \item JAN 2018, Visiting Researcher, KAIST, Korea.
  \item SEP 2014 $\sim$ DEC 2017, Postdoctoral Fellow, \href{https://appliedpde.kaust.edu.sa/Pages/People-Page.aspx}{Applied PDE Group}, KAUST. Advisor: Athanasios Tzavaras.%King Abdullah University of Science \& Technology
\end{itemize}

\section*{Education}
\begin{itemize}
  \item Ph.D. Department of Mathematical Science, Korea Institute of Science and Technology (KAIST), 2014.
  \item M.S. Department of Mathematical Science, KAIST, 2009.
  \item B.S. Department of Mathematics, KAIST, 2007.
  \vskip 0.6em \hskip 3em Minor degree from Department of Electrical Engineering.
...
\item Plastic deformations, Thermo-mechanical problem, Continuum mechanics.
\item Nonlinear Partial differential equations, Hyperbolic conservation laws.
...
\section*{Grants}
\begin{itemize}
  \item 2011$\sim$2014, National Junior Research Fellowship, National Research Foundation of Korea.
\end{itemize}

\section*{Visitings, Academic Activities}
\begin{itemize}
  \item Hausdorff center for mathematics, Bonn, Germany, May 21-26, 2017.
  \item Universitty of Vienna, Vienna, Austria, May 1-5, 2017.
...
\begin{enumerate}
  \item Localization and the formation of shear bands in thermoviscoplastic deformations.
  \item Proton diffusion problem in collaboration with the Interfacial Lab in Environmental Science and Engineering.
  \item Polyconvex energy and entropy techniques with higher gradient(Euler-Korteweg) / non-local contributions(Euler-Poisson).
  \item Boundary value problems of viscosity-capillarity system (Euler-Korwege / Navier-Stokes-Koteweg).
  \item 2010.03 $\sim$ 2012.02, Virtual Resistive Network \& a Development of an Anisotropic Conductivity Reconstruction Method for a Medical Imaging, Korea Science and Engineering Foundation.
  \item 2010.09 $\sim$ 2012.12, Homing Guidance Loop Design and Analysis Based on Confluent Hypergeometric Kummer Differential Equation, Korean Agency for Defense Development.
\end{enumerate}
...
\begin{enumerate}
\item Min-Gi Lee, Athanasios Tzavaras, Localization of viscous fluid via geometric theory of singular perturbation. {\it submitted to Siam J. Appl. Dyn. Systems}, (preprint).
...
\item Min-Gi Lee, Athanasios Tzavaras, Existence of localizing solutions in plasticity via the geometric theory of singular perturbations, {\it Siam J. Appl. Dyn. Systems} 16 (2017), no. 1, 337--360.% (arXiv:1608.00198).
...
%\begin{enumerate}
\item Yong-Jung Kim, Min-Gi Lee and Marshall Slemrod, Thermal creep of a rarefied gas on the basis of non-linear Korteweg-theory, {\it Arch. Ration. Mech. Anal.} 215 (2015), no.2, 353-379.
...
\begin{itemize}
  ...
  \item 1D $C^p$ Lagrangian basis Finite element methods.
  \item Mini-course taken on Finite volume methods, KAUST, SA, 2016.
\end{itemize}
...
% \item Jos\'e Antonio Carrillo De La Plata
%
% \quad
% \begin{minipage}{0.7\linewidth}
%     Chair in Applied and Numerical Analysis,\\
%     Department of Mathematics, Imperial College London \\
%     London SW7 2AZ, United Kingdom\\
%     email : carrillo@imperial.ac.uk\\
%     phone : +44 (0)20 7594 8530 \\
%     homepage : \href{http://www.imperial.ac.uk/people/carrillo}{\tt\url{http://www.imperial.ac.uk/people/carrillo}}
% \end{minipage}

\item Juan J. L. Vel\'azquez

\quad
\begin{minipage}{0.7\linewidth}
    Professor,\\
    Institute for Applied Mathematics, Hausdorff Center for Mathematics \\
    Villa Maria Endenicher Allee 62, Bonn, Germany\\
    email : velazquez@iam.uni-bonn.de\\
    phone : +49 228 73 62378 \\
    homepage : \href{http://www.hcm.uni-bonn.de/people/profile/juan-j-velazquez/}{\tt\url{http://www.hcm.uni-bonn.de/people/profile/juan-j-velazquez/}}
\end{minipage}
...
\begin{itemize}
  \item {Two-parameters family of focusing self-similar solutions in adiabatic shear deformation of thermo-visco-plastic materials}
    \begin{itemize}
      \item Hausdorff center for mathematics, Bonn, Germany, May 23rd, 2017
    \end{itemize}
  \item {Two-parameters family of focusing self-similar solutions in adiabatic shear deformation of thermo-visco-plastic materials}
    \begin{itemize}
      \item University of Vienna, Vienna, Austria, May 3rd, 2017
    \end{itemize}
