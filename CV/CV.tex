...
\begin{enumerate}
  ...
  \item Polyconvex energy and entropy techniques with higher gradient / non-local contributions.
  \item Boundary value problems of viscosity-capillarity system.
